...
try {
 ...
 // p5-24: the client file sections are toggle buttons (aria-expanded), no longer <details>.
 await page.getByTestId('client-file-questionnaires').locator('button[aria-expanded]').first().click();
