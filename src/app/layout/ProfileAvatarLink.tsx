...
export default function ProfileAvatarLink() {
  ...
  return (
    <Link
      ...
      className="block w-11 h-11 rounded-xl overflow-hidden flex-shrink-0 ring-2 ring-neutral-800 hover:ring-line-strong focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-400"
