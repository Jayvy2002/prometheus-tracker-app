...
export function useExerciseHistory(
  ...
  useEffect(() => {
    ...
    fetchExerciseHistory(user.id, exerciseName, workoutId, 5, catalogExerciseId).then(setHistory);
  }, [user?.id, exerciseName, workoutId, catalogExerciseId]); // eslint-disable-line react-hooks/exhaustive-deps
