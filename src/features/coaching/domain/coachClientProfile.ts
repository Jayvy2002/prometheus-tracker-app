import { DIET_TYPES, GOALS, TRAINING_EXPERIENCES, TRAINING_FOCUSES } from '../../../lib/constants';
...
export function profileToVisiblePatch(profile: UserProfile): ClientVisibleProfilePatch {
  return {
    ...
    daily_water_target_ml: profile.daily_water_target_ml ?? undefined,
    daily_steps_target: profile.daily_steps_target ?? undefined,
