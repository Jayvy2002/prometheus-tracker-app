...
export default function HealthIntegrations() {
  ...
  return (
    <div className="px-4 pt-6">
      <button onClick={() => navigate('/profile')} className="flex items-center gap-2 text-neutral-400 hover:text-white mb-6 transition-colors">
        <ArrowLeft size={18} /> <span className="text-sm">Back</span>
      </button>
      <h1 className="text-2xl font-bold text-white mb-2">Health Integrations</h1>
      <p className="text-sm text-neutral-400 mb-6">Connect external health services to sync your data</p>

      <div className="mb-6 bg-blue-600/10 border border-blue-500/30 rounded-2xl p-4 flex items-start gap-3">
