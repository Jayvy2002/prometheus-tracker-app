...
/** Barre globale : une séance non terminée se reprend depuis n'importe quel écran. */
export default function SessionResumeBar() {
  ...
  const open = (current && !current.completed ? current : null)
  ...
  return (
    <button
      ...
      className="fixed z-30 left-3 right-3 md:left-72 md:right-6 bottom-[calc(4.5rem+env(safe-area-inset-bottom))] min-h-11 rounded-2xl bg-blue-600 px-4 text-sm font-medium text-white shadow-lg"
    >
