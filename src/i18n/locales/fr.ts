const fr = {
  ...
  coaching: {
    ...
    fleet: {
      ...
      noCalorieEditor: 'Macros incomplètes : on n’ouvre pas l’éditeur calories. Relance ou macros complètes seulement.',
    ...
    fiche: {
      ...
      targetsHint: 'Ces cibles s’écrivent uniquement quand tu enregistres. ISSN reste une formule de départ — jamais d’écriture automatique.',
    },
    loop: {
