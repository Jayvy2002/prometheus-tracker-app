const fr = {
  ...
  soloProgram: {
    ...
    refuse: 'Refuser — mes routines',
    accepted: 'Programme assigné. Tu peux t’entraîner.',
    refused: 'Proposition refusée. Tes routines restent ta source.',
  ...
  programs: {
    ...
    soloSubtitle: 'Le plan que tu as accepté. Un ajustement (blessure, priorité, séances) est un patch — rien ne se régénère tout seul.',
    soloEmpty: 'Pas encore de programme. Ton copilote en propose un après l’intake — tu acceptes ou tu refuses.',
  ...
  intake: {
    ...
    reviewOriginal: 'Questionnaire (formulaire d’origine)',
    extrasTitle: 'Questions supplémentaires',
    extrasHint: 'Ajouts après le formulaire Google — elles ne remplacent aucune question d’origine.',
    screens: {
      you: 'Toi',
      goal: 'Objectif',
      time: 'Temps',
