const fr = {
  ...
  coaching: {
    ...
    setup: {
      ...
      aiTitle: 'Brouillon IA (optionnel)',
      aiHint: 'Suggestions seulement. Tu peux accepter, modifier ou jeter. Le plan client n’est pas mis à jour tant que tu n’as pas confirmé ci-dessous.',
      aiGenerate: 'Générer un brouillon',
      aiApply: 'Appliquer le brouillon au formulaire',
      aiApplied: 'Brouillon copié dans le formulaire — pas encore enregistré',
      aiUnavailable: 'IA indisponible. Continue le parcours manuel.',
      ...
      programHint: 'Assigne un programme existant ou confirme une nouvelle trame. Même outil Programmes.',
      newOrPick: 'Créer depuis la trame / plus tard',
      openPrograms: 'Ouvrir Programmes pour en construire un',
      confirm: 'Confirmer la configuration',
      confirmHint: 'Toi seul valides — confirme pour enregistrer le suivi, les cibles optionnelles et le programme.',
