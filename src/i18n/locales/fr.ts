const fr = {
  ...
  nutrition: {
    ...
    weeklyAdjustment: {
      ...
      coachDecides: 'Ton coach décide des cibles. Rien n’est écrit tout seul — les propositions hebdo passent par une carte coach.',
      messages: {
        stableUnderEating: 'Poids stable mais tu es en dessous de ton objectif calorique.',
        stableUnderEatingReason: 'Le plan n’est pas vraiment suivi : on ne change pas la cible. Ton coach pourra Relancer.',
        stableNoLoss: "Le poids n'a pas changé depuis 2 semaines.",
        stableNoLossReason: 'Si tu suis le plan, ton coach pourra proposer une petite baisse. Rien n’est écrit tout seul.',
        losingTooFast: 'Perte trop rapide ({{diff}} kg / 2 semaines).',
        losingTooFastReason: 'Le rythme est un peu vif — ton coach verra si on réduit le déficit. Rien n’est écrit tout seul.',
        weightUpOvereating: 'Poids en hausse de {{diff}} kg — tu dépasses ton objectif de {{pct}}%.',
        weightUpOvereatingReason: 'Logs au-dessus de la cible : on Relance, on ne coupe pas les calories tant que le plan n’est pas suivi.',
        weightIncreased: 'Poids augmenté de +{{diff}} kg sur 2 semaines.',
        weightIncreasedReason: 'Si tu suis le plan, ton coach pourra proposer une baisse plus franche. Rien n’est écrit tout seul.',
        goodPace: 'Bon rythme : −{{diff}} kg sur 2 semaines.',
        goodPaceReason: 'Tu perds à un rythme sain — on garde les cibles.',
        bulkNotIncreasing: "Le poids n'augmente pas depuis 2 semaines.",
        bulkNotIncreasingReason: 'Si tu suis le plan, ton coach pourra proposer une petite hausse. Rien n’est écrit tout seul.',
        bulkTooFast: 'Prise trop rapide (+{{diff}} kg / 2 semaines).',
        bulkTooFastReason: 'Si tu suis le plan, ton coach pourra réduire un peu le surplus. Rien n’est écrit tout seul.',
        bulkOnTrack: 'Dans les temps : +{{diff}} kg sur 2 semaines.',
        bulkOnTrackReason: 'Le rythme est bon — on garde les cibles.',
        maintainChanged: 'Poids {{direction}} de {{diff}} kg.',
        maintainChangedReason: 'Ton coach verra si on recale. Rien n’est écrit tout seul.',
