const fr = {
  ...
  soloReview: {
    ...
    guarded: 'Tes chiffres bougent, mais ton profil demande une revue avec un pro plutôt qu’un ajustement automatique. Continue de logger, garde tes habitudes, et parles-en à un coach ou un pro de santé.',
  ...
  programs: {
    ...
    askCopilotHint: 'Le copilote propose. Rien ne change tant que tu n’enregistres pas.',
    ...
    noSilentApply: 'Rien ne s’applique tout seul. Enregistre pour que tes séances suivent ce plan.',
    ...
    archivesReadOnly: 'Lecture seule — ton historique suit, même en changeant de coach.',
