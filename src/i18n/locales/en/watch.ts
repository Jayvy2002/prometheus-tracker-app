const watch = {
  prometheusWatch: {
    ...
    decide: {
      ...
      modify: 'Modify',
      refuse: 'Decline',
      titleAccept: 'Accept this proposal',
      titleModify: 'Record a change (without applying it)',
      titleRefuse: 'Decline this proposal',
      reasonLabel: 'Reason',
      reasonHelpAccept: 'Optional. Targets, sessions and programs are not changed from this panel.',
      reasonHelpRequired: 'Explain your decision. Logged sessions, meals and programs stay as they are.',
