const en = {
  ...
  onboarding: {
    ...
    fields: {
      ...
      coachOwnsTargets: 'Your coach will send kcal / macro targets. Nothing is written on its own.',
  ...
  soloReview: {
    title: 'Your copilot — last 2 weeks',
    insufficient: 'Weigh in and log your meals: your copilot reviews every week once it has 2 weigh-ins and a few logged days.',
    keep: 'Trajectory looks right: {{delta}} kg over {{window}} days with an average of {{avg}} kcal ({{pct}}% of your target). Keeping {{from}} kcal.',
    relance: {
      few_logs: 'Can’t judge your target: {{loggedDays}} day(s) logged out of {{window}}. Numbers stay as they are — aim for consistency this week and the review will follow.',
      over_target: 'Your average is {{pct}}% of your target ({{avg}} kcal). Until the plan is followed, numbers stay as they are — consistency is what’s missing, not the target.',
      under_target: 'Your average is {{pct}}% of your target ({{avg}} kcal): you’re eating under your plan. Not lowering the target — get back to it first, then we’ll judge the weight.',
    },
    adjust: {
      ...
      bulk_too_fast: 'You’re gaining too fast ({{pctWeek}}% of bodyweight per week) — part of it is likely fat. Proposal: {{from}} → {{to}} kcal.',
    ...
    guarded: 'Your numbers are moving, but your profile calls for a review with a professional rather than an automatic adjustment. Keep logging, keep your habits, and talk to a coach or health professional.',
    apply: 'Apply {{n}} kcal',
  ...
  soloProgram: {
    ...
    nothingAuto: 'Review the sessions, edit anything you want, then accept. Nothing applies on its own.',
    why: 'Why',
    ...
    draftingBody: 'This takes a few seconds. The proposal will show here — nothing applies on its own.',
    patchNoProgram: 'No assigned program to patch. Refuse, or wait for a full proposal.',
    adjustTitle: 'Adjust the program',
    adjustHint: 'Injury, focus, session count: the copilot proposes a patch, not a blind regen.',
  ...
  coaching: {
    ...
    setup: {
      ...
      aiHint: 'Prometheus may suggest a program and tracking. You can edit or ignore it and build everything by hand. Calories stay the onboarding formula until you change them. Nothing is assigned until you send below.',
      ...
      trackingHint: 'These choices hide fields on the client app and your alerts. Nothing is saved until you confirm.',
      track: {
        workouts: 'Workouts',
      ...
      issnLabel: 'App ISSN formula — not a seed or an AI proposal.',
      targetsHint: 'Starting point from the app ISSN formula. Nothing is written to the client unless you check the box.',
    ...
    interventions: {
      ...
      macrosRequired: 'Macros must be complete (protein, carbs, fat > 0) and match the calories. 2000/0/0/0 cannot be sent.',
    ...
    command: {
      title: 'Today',
      subtitle: 'Today: the queue, then the file (360). You send in Messages. Nothing auto-applies.',
      stats: {
    ...
    nutritionStall: {
      ...
      hint: 'The fleet round prepares a nudge message. You send it. ISSN stays the app formula.',
    ...
    ask: {
      ...
      subtitle: 'Roster filters read your logs. Every program / copilot draft goes through the in-app agent — you confirm.',
      ...
      unknownBody: 'Try a roster filter (pain, stall, missed) or a client + lift. Optional: ask Prometheus for an editable draft.',
      secondHookTitle: 'Prometheus draft',
      secondHookBody: 'Local parser cannot answer this fully. Send the question as an editable draft — you confirm before anything is sent.',
      sendToSecond: 'Ask for a draft',
      sentToSecond: 'Draft created — nothing auto-applied',
      secondDraftTitle: 'Ask Prometheus',
    },
    second: {
      drafting: 'Prometheus is writing the draft…',
      draftingHint: 'A few seconds. Nothing is sent to the client until you confirm.',
      landed: 'Draft received — edit then send.',
      failed: 'Prometheus could not write. Retry — nothing was applied.',
      retry: 'Retry',
      badge: 'Prometheus draft',
      createProgram: 'Create an AI program',
      createProgramHint: 'Prometheus drafts a program + tracking. Calories stay ISSN. You confirm before anything is sent.',
    ...
    fleet: {
      title: 'Coach round',
      hint: 'SQL first, one card only if something needs doing. AI prepares, you send. Nothing auto-applies.',
      run: 'Run the round',
    ...
    learned: {
      ...
      subtitle: 'Lessons (what you sent vs what the agent proposed) and fleet-round history. Nothing applies on its own.',
      open: 'See what Prometheus learned',
      lessons: 'Lessons',
      lessonsEmpty: 'No lessons yet. They appear when you edit a draft then send it.',
      rounds: 'Rounds',
    ...
    fiche: {
      goal: 'Goal',
      save: 'Save file',
      saved: 'File saved — nothing auto-applied',
      confirmHint: 'You confirm. AI never writes the profile.',
      invalid: 'Invalid field: {{field}}',
      targetsHint: 'Kcal / macro targets are written only when you Send a complete draft. No editor here.',
      noSentTargets: 'No targets sent yet. Prometheus prepares a draft; you send.',
    },
    loop: {
  ...
  programs: {
    ...
    soloSubtitle: 'The plan you follow. Add, remove, or reorder days and exercises — like a routine. The copilot can also propose a patch.',
    ...
    askCopilotHint: 'The copilot proposes. Nothing changes until you save.',
    ...
    savePlan: 'Save plan',
    noSilentApply: 'Nothing applies on its own. Save so your sessions follow this plan.',
    soloEmpty: 'No program yet. Your copilot proposes one after intake, or you build it here.',
    ...
    archivesReadOnly: 'Read-only — your history follows you, even when changing coaches.',
