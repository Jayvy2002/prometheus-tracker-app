const en = {
  ...
  coaching: {
    ...
    fleet: {
      ...
      noCalorieEditor: 'Incomplete macros: the calorie editor stays closed. Nudge or complete macros only.',
    ...
    fiche: {
      ...
      targetsHint: 'These targets are written only when you save. ISSN stays a starting formula — never auto-written.',
    },
    loop: {
