const en = {
  ...
  nutrition: {
    ...
    weeklyAdjustment: {
      ...
      ofTarget: '% of target',
      apply: 'Apply {{n}} kcal',
      coachDecides: 'Your coach decides targets. Nothing is written automatically — weekly proposals go through a coach card.',
      messages: {
        stableUnderEating: "Weight stable but you're under your calorie target.",
        stableUnderEatingReason: "The plan isn't really being followed: we don't change the target. Your coach can follow up.",
        stableNoLoss: "Weight hasn't changed over the last 2 weeks.",
        stableNoLossReason: 'If you are following the plan, your coach may propose a small reduction. Nothing is written automatically.',
        losingTooFast: 'Losing too fast ({{diff}} kg / 2 weeks).',
        losingTooFastReason: 'The pace is a bit fast — your coach will review the deficit. Nothing is written automatically.',
        weightUpOvereating: 'Weight up {{diff}} kg — you\'re over your target by {{pct}}%.',
        weightUpOvereatingReason: 'Logs are above target: follow up first, do not cut calories until the plan is followed.',
        weightIncreased: 'Weight increased +{{diff}} kg over 2 weeks.',
        weightIncreasedReason: 'If you are following the plan, your coach may propose a larger reduction. Nothing is written automatically.',
        goodPace: 'Good pace: −{{diff}} kg over 2 weeks.',
        goodPaceReason: "You're losing at a healthy rate — keep current targets.",
        bulkNotIncreasing: "Weight isn't increasing over the last 2 weeks.",
        bulkNotIncreasingReason: 'If you are following the plan, your coach may propose a small increase. Nothing is written automatically.',
        bulkTooFast: 'Gaining too fast (+{{diff}} kg / 2 weeks).',
        bulkTooFastReason: 'If you are following the plan, your coach may trim the surplus. Nothing is written automatically.',
        bulkOnTrack: 'On track: +{{diff}} kg over 2 weeks.',
        bulkOnTrackReason: 'Pace is good — keep current targets.',
        maintainChanged: 'Weight {{direction}} by {{diff}} kg.',
        maintainChangedReason: 'Your coach will review. Nothing is written automatically.',
