const en = {
  ...
  soloProgram: {
    ...
    refuse: 'Refuse — my routines',
    accepted: 'Program assigned. You can train.',
    refused: 'Proposal dismissed. Your routines stay your source.',
  ...
  programs: {
    ...
    soloSubtitle: 'The plan you accepted. An adjustment (injury, focus, sessions) is a patch — nothing regenerates on its own.',
    soloEmpty: 'No program yet. Your copilot proposes one after intake — you accept or refuse.',
  ...
  intake: {
    ...
    reviewOriginal: 'Questionnaire (original form)',
    extrasTitle: 'Additional questions',
    extrasHint: 'Added after the Google Form — they do not replace any original question.',
    screens: {
      you: 'You',
      goal: 'Goal',
      time: 'Time',
