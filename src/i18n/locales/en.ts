const en = {
  ...
  marketplace: {
    ...
    coachingActive: 'The coach accepted. Coaching is now active. No payment is required for now.',
    coachingActiveCoach: 'This client is now in your roster. No payment is required for now.',
