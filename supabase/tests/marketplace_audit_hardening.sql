...
END $$;
ROLLBACK;
\echo 'marketplace: publication, consent, isolation, athlete confirm activates coaching, historical confirmation does not reactivate, leftover accepted stays accepted'
