...
**Consentement d’invitation directe — candidat à valider, non livré.** L’acceptation transmet une version et la liste annoncée des catégories de données. Le serveur refuse une version obsolète, un périmètre incomplet et l’ancienne RPC sans consentement ; il conserve un enregistrement lisible uniquement par les deux parties et le révoque à la fin de la relation. Ce premier contrat porte sur l’invitation directe avec un périmètre maximal fixe ; le choix fin des modules et le consentement propre à l’activation marketplace restent à construire.
