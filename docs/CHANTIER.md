...
**Mis à jour : 15 septembre 2026.** Lots 1–16 + 16f–16g + **17–19** + **20 coaching/marketplace/workout/nutrition** dans `new-JV`. File ouverte : **lot 20 programs**. Lots 21–23 après. Une CI verte ne clôt pas une ligne UX.

| **Lot ouvert : 20** (reste programs). Lots **17–19** dans `new-JV`. Lots 11–16 : apply prod + parcours encore dus. Lots 2–10 : **2 Terminé** ; **3–10 Partiel**.
...
| **20** | **Migrer `src/lib` par domaine** (ARCH01) | **Partiel** | Coaching + marketplace + workout + nutrition livrés. **Reste :** programs. |
...
| 20 | **Coaching + marketplace + workout + nutrition livrés.** Reste programs dans `lib/`. |
