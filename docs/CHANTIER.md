...
**Mis à jour : 15 septembre 2026.** Lots 1–16 + 16f–16g + **17–20** dans `new-JV`. File ouverte : **lot 21** (découper App / gros composants / coachingStore). Lots 22–23 après. Une CI verte ne clôt pas une ligne UX.

| **Lot ouvert : 21**. Lots **17–20** dans `new-JV`. Lots 11–16 : apply prod + parcours encore dus. Lots 2–10 : **2 Terminé** ; **3–10 Partiel**.
