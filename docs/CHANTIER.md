...
Le parcours navigateur de la base isolée vérifie le passage Personnel/Coaching, l’accès du coach à ses outils d’entraînement, la conservation au rechargement et l’isolation de la préférence entre deux comptes. Restent : inventaire exhaustif des prédicats frontend/SQL/IA, bascule complète des capacités, mutations entre appareils et validation élargie des parcours de changement de compte. Ne pas annoncer la migration de rôles terminée à partir de la seule table de compatibilité.
