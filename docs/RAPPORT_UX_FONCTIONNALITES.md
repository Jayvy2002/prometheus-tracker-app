...
| **Marche** | Un seul coach actif. Marketplace ne force pas un second lien. Permission notif après la séance (UX64), pas à l’inscription. Audience / export JSON / delete **SUPPRIMER** dans Avancé (UX66). |
...
| **Changer** | Trois états **lisibles** : brouillon · enregistré · publié/assigné. Assign = récap destinataire / date / remplacement. L’athlète voit la séance nommée + weekday, le coach la structure (UX22 **Terminé**). |
