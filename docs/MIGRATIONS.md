...
- `migrations.pending.json` contient les candidates P4.1 `20260921021231_p4_coach_qualifications` et P4.2 `20260921021923_p4_explained_matching` (non appliquées) ;
