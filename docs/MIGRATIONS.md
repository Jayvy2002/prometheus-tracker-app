...
- Déploiement **effectif** des deux edges d’audit (10 sept. soir) : **Supabase Management API** (connexion authentifiée ChatGPT), pas une preuve CLI. Live : `coach-fleet-round` v32 / `coach-agent` v26. v26 conserve le bundle métier audité et corrige l’encodage UTF-8 du wrapper ; OPTIONS 200, POST sans JWT 401.
