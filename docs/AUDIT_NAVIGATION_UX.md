...
> **Recalé 23 sept. 2026.** L’onglet coaché mobile est Accueil · Séance · Corps · Coach · Toi. Le solo a Suivi (Exercices · Corps · Calendrier). Le minuteur de repos est une barre, Terminer est dans le header, et la séance en cours a une barre Reprendre. Le détail historique de cet audit (14–15 sept.) décrit l’état d’avant ces changements.
