...
> **Recalé 23 sept. 2026 (PR #221).** Mobile, cinq onglets au plus. Solo : Aujourd’hui · Séance · Corps · Suivi · Toi. Coaché : Aujourd’hui · Séance · Corps · Messages · Toi. Séance et Corps n’apparaissent que si le module est suivi. Corps regroupe Nutrition · Poids · Check-in ; Suivi regroupe Exercices · Tendances · Calendrier. Un onglet reste allumé sur ses sous-pages. Les routines personnelles restent réservées au Solo. Desktop Coach : Aujourd’hui · Clients · Messages · Programmes, puis Copilote, « Mon offre » (profil public, demandes) et « Import » ; « Trouver un coach » est dans l’espace personnel Solo. L’ajout rapide « Séance » ouvre la page Entraînement. Marketplace athlète : un seul lieu « Trouver un coach » avec deux onglets (Coachs, Mes demandes) et une recherche guidée. Le minuteur de repos est une barre, Terminer est dans le header, et une séance d’aujourd’hui ou d’hier a une barre Reprendre. Le détail historique de cet audit (14–15 sept.) décrit l’état d’avant ces changements.
