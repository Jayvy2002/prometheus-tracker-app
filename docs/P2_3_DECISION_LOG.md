...
la décision `corrected` sur cette même table. Stripe / P6.
...
le 19 septembre 2026 (lock **122**). La correction P2.4 ajoute un candidat
`20260919134856_watch_context_correction` (pending), sans restamp du lock.
